...
func Load() Config {
	...
	//c.PostgresHost = cast.ToString(getOrReturnDefault("POSTGRES_HOST", "172.17.0.1:5332"))
	...
	c.RPChost = cast.ToString(getOrReturnDefault("DOCKER_TEST/user-service_HOST", "user-service"))
